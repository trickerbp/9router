...
export const APIKEY_PROVIDERS = {
  ...
  blackbox: { id: "blackbox", alias: "bb", name: "Blackbox AI", icon: "smart_toy", color: "#5B5FEF", textIcon: "BB", website: "https://blackbox.ai", notice: { apiKeyUrl: "https://www.blackbox.ai/api-management" }, thinkingConfig: THINKING_CONFIG.effort, serviceKinds: ["llm"] },
  venice: { id: "venice", alias: "venice", name: "Venice AI", icon: "shield", color: "#DC2626", textIcon: "VE", website: "https://venice.ai", notice: { text: "OpenAI-compatible private inference with Venice, GLM, Qwen, DeepSeek, and Llama models.", apiKeyUrl: "https://venice.ai/settings/api" }, passthroughModels: true, serviceKinds: ["llm", "embedding", "image"], embeddingConfig: { baseUrl: "https://api.venice.ai/api/v1/embeddings", authType: "apikey", authHeader: "bearer", models: [{ id: "text-embedding-3-large", name: "Text Embedding 3 Large" }, { id: "text-embedding-bge-m3", name: "BGE-M3 Embedding" }, { id: "text-embedding-qwen3-8b", name: "Qwen3 8B Embedding" }] }, imageConfig: { baseUrl: "https://api.venice.ai/api/v1/images/generations", authType: "apikey", authHeader: "bearer" }, modelsFetcher: { url: "https://api.venice.ai/api/v1/models", type: "openai" } },
