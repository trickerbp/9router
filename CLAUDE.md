...
This project is indexed by GitNexus as **9router** (14292 symbols, 29707 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
