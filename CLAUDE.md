...
This project is indexed by GitNexus as **9router** (15135 symbols, 31714 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
